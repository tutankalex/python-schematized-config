  ...
  'syms': { 'schematized_config.cli': { 'schematized_config.cli._hack_docstring': ('cli.html#_hack_docstring', 'schematized_config/cli.py'),
            ...
            'schematized_config.core': { 'schematized_config.core.ConfigValidator': ( 'core.html#configvalidator',
                                         ...
                                         'schematized_config.core.ConfigValidator.__init__': ( 'core.html#configvalidator.__init__',
                                                                                               'schematized_config/core.py'),
                                         'schematized_config.core.ConfigValidator._get_maybe_abspath_driver': ( 'core.html#configvalidator._get_maybe_abspath_driver',
                                                                                                                'schematized_config/core.py'),
                                         'schematized_config.core.ConfigValidator.get_default_json_schema': ( 'core.html#configvalidator.get_default_json_schema',
                                                                                                              'schematized_config/core.py'),
                                         'schematized_config.core.ConfigValidator.get_default_storage_driver': ( 'core.html#configvalidator.get_default_storage_driver',
                                                                                                                 'schematized_config/core.py'),
